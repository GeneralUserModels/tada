...
export function StatusBar({ labels, queue, step, buffer }: Props) {
  return (
    <div className="status-bar">
      ...
      <div className="stat-pill" title="Screen events waiting to trigger a training step">
      ...
      <div className="stat-pill" title="Connector events in memory used as model context">
